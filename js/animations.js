...
// The load event waits on the CDN assets. If one of them hangs the loader
// would cover the page forever, so start it once the DOM is ready anyway.
document.addEventListener("DOMContentLoaded", () => {
  setTimeout(startLoader, 2000);
});

// Last resort: anime.js drives the fade with requestAnimationFrame, which is
// paused in background tabs. Reveal the page outright if it never finished.
setTimeout(() => {
